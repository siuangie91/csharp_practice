...
namespace ArraysAndLists
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //var trackLikes = new TrackLikes();
            //var reverseName = new ReverseName();
            //var sortUniqueNumbers = new SortUniqueNumbers();
            //var displayUniqueNumbers = new DisplayUniqueNumbers();
            var smallestInList = new SmallestInList();
        }
